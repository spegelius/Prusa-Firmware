...
#define E_MOTOR_LOW_CURRENT 450 // current for PRUSAY code
...
#define DEFAULT_PWM_MOTOR_CURRENT  {270, 830, 750} // {XY,Z,E}
#define DEFAULT_PWM_MOTOR_CURRENT_LOUD  {540, 830, 850} // {XY,Z,E}
#define Z_SILENT 0
