...
#define STRING_CONFIG_H_AUTHOR "spegelius@gmail.com" // Who made the changes.
...
#define EXTRUDER_WATTS (2.27*2.27/5.4) //  P=I^2/R
#define BED_WATTS (11.2*11.2/1.1)      // P=I^2/R
